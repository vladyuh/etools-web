...
detailContent.addClass('is-active'); //Browser-level image lazy-loading
...
$(".header-darkMode").click(function () {
  if ($(this).hasClass("enabled")) {
    js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.remove('darkmode');
    $(this).removeClass("enabled");
    js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.set("darkmode", "disabled", {
      expires: 365
    });
    ...
    $("html").addClass("dark");
    js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.set("darkmode", "enabled", {
      expires: 365
    });
  }
});
...
$(".results__search input").on("input focus", function () {
  if ($(this).val() == "") {
    ...
    if ($(".results__table tbody tr td:contains(" + $(this).val() + ")")) {
      ...
      $(".results__table tbody tr td:contains(" + $(this).val() + ")").parents(".results__table tbody tr").show();
    }
  }
});
